...
class SubjectList extends React.Component {
  ...
  render() {
    let component = this;
    let nestedSecondSubjects = [];
    let nestedThirdSubjects = [];
      ...
      <List>
        ...
        {this.state.subjects.map(function(subject){
          if (component.state.topSubjects.includes(subject)) {
            return(
              <Subheader key={subject.id}> {subject.subject}  </Subheader>
            )

        }  else if (component.state.thirdSubjects.includes(subject)) {
              return (
                nestedThirdSubjects.push(<ListItem primaryText={subject.subject} key={subject.id} leftCheckbox={<Checkbox />}/>)
              )


          } else if (component.state.secondSubjects.includes(subject)) {
              let nestedItems = []
              nestedThirdSubjects.map(function(nestedSubject) {

              if (component.state.secondSubjects.includes(nestedSubject)) {
                return (
                  nestedItems.push(nestedSubject)
                )
                }
              })
...
// } else if (component.state.secondSubjects.includes(subject)) {
//   return(
//     <ListItem primaryText={subject.subject} key={subject.id} title={subject.subject} />
//   )
// } else if (component.state.thirdSubjects.includes(subject)) {
//   return(
//     <ListItem primaryText={subject.subject} key={subject.id} title={subject.subject} />
